...
export function ClubsSection() {
  return (
    <section
      className="container relative py-16 md:px-12 lg:px-16 pt-[6rem]"
      id="clubs"
    >
      <div className="flex flex-col items-center mb-10">
        ...
        <p className="text-gray-600 dark:text-gray-400 max-w-2xl text-center">
          Student-run clubs and chapters that power learning, projects and
          events across Skepsis.
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
          {CLUBS.map((club) => {
            ...
            return (
              <article
                key={club.id}
                className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm overflow-hidden hover:shadow-md transition flex flex-col md:flex-row"
              >
                ...
                <div className="p-6 flex flex-col justify-between">
                  ...
                  <div className="mt-6 flex items-center justify-between">
                    ...
                    <a
                      href="#"
                      className="text-sm px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-full text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition"
                    >
                      Learn more
                    </a>
                  </div>
