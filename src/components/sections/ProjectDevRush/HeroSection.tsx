  ...
  return (
    <section className="min-h-screen flex flex-col items-center justify-center px-4 py-16 md:py-20 relative overflow-hidden bg-white dark:bg-gray-950">
      ...
      <div className="text-center space-y-8 max-w-3xl mx-auto relative z-10">
        ...
        {/* TEMPORARY: Hidden date range + countdown (DO NOT DELETE - needed later) */}
        {/*
        <p className="text-lg md:text-xl text-gray-600 dark:text-gray-400">
          {projectDevRushData.hero.dateRange}
        </p>
        ...
        */}
        ...
        {/* TEMPORARY MESSAGE (REPLACE COUNTDOWN FOR NOW) */}
        <p className="text-2xl md:text-4xl font-bold bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-[length:200%_200%] bg-clip-text text-transparent animate-[gradient_6s_ease_infinite]">
